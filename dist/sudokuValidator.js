// 横列に同じ値がないか調べる.
export function rowValid(rowindex, colindex, value, anser) {
...
// 縦列に同じ値がないか調べる。
export function colValid(rowindex, colindex, value, anser) {
    for (var i = 0; i <= 9; i++) {
...
// 3×3マスないに同じ値がないか調べる。
export function aroundValid(rowindex, colindex, value, anser) {
    // どの位置に属しているのか判別する
